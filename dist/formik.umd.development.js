(function (global, factory) {
  ...
  function useFormikContext() {
    var formik = React.useContext(PrivateFormikContext);
  ...
  function useFormik(_ref) {
    ...
    var getFieldProps = React.useCallback(function (_ref4) {
      var name = _ref4.name,
          type = _ref4.type,
  ...
  function useField(propsOrFieldName) {
    ...
    if (isObject(propsOrFieldName)) {
      {
        !propsOrFieldName.name ? invariant(false, 'Invalid field name. Either pass `useField` a string or an object containing a `name` key.') : void 0;
      }
